...
const idx = xml.indexOf('Worked Example (0606/PYP Style)')
const snippet = xml.slice(idx, idx + 6000)
const paras = snippet.split(/<w:p[ >]/).slice(1, 25)
for (const p of paras) {
  const sup = /w:vertAlign[^>]*w:val="superscript"/.test(p)
