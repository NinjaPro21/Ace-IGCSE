#!/usr/bin/env node
/**
 * Repair quiz JSON for Add Math Ch.1 topics only.
 *
 * WARNING: Runs prepareMathContent() which can over-wrap bare y=|…| as display
...
const chapter = JSON.parse(
  fs.readFileSync(
    path.join(__dirname, '../content/chapters/add-maths-0606/ch01-functions.json'),
    'utf8',
  ),
)
...
console.log(`Repaired ${files} Ch.1 quiz files (${questions} questions).`)
