#!/usr/bin/env node
/** Repair quiz JSON for Add Math Ch.15 topics only. */
import fs from 'fs'
...
const chapter = JSON.parse(
  fs.readFileSync(
    path.join(__dirname, '../content/chapters/add-maths-0606/ch15-calculus-integration.json'),
    'utf8',
  ),
)
...
console.log(`Repaired ${files} Ch.15 quiz files (${questions} questions).`)
