#!/usr/bin/env node
/** Repair quiz JSON for Add Math Ch.12 topics only. */
import fs from 'fs'
...
const chapter = JSON.parse(
  fs.readFileSync(
    path.join(__dirname, '../content/chapters/add-maths-0606/ch12-calculus-differentiation-1.json'),
    'utf8',
  ),
)
...
console.log(`Repaired ${files} Ch.12 quiz files (${questions} questions).`)
