#!/usr/bin/env node
/** Repair quiz JSON for Add Math Ch.9 topics only. */
import fs from 'fs'
...
const chapter = JSON.parse(
  fs.readFileSync(
    path.join(__dirname, '../content/chapters/add-maths-0606/ch09-trigonometry.json'),
    'utf8',
  ),
)
...
console.log(`Repaired ${files} Ch.9 quiz files (${questions} questions).`)
