...
const chapter = JSON.parse(
  fs.readFileSync(
    path.join(__dirname, '../content/chapters/add-maths-0606/ch07-coordinate-geometry-of-the-circle.json'),
    'utf8',
  ),
)
...
console.log(`Repaired ${files} Ch.7 quiz files (${questions} questions).`)
