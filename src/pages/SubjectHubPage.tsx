...
import { getChapterMasteryPercent, getChapterStatus, getChaptersForSubject, getSubject } from '@/lib/contentLoader'

export function SubjectHubPage() {
  const { subjectId = 'add-maths-0606' } = useParams()
  const { getChapterQuizLevel, getTopicNotesReadMap } = useMastery()
      ...
      <div className="enlight-container enlight-page-padding">
        ...
        <div className="enlight-legend">
          ...
          <span className="enlight-legend__item">
            ...
            In progress — opened a topic or started a quiz
          </span>
          <span className="enlight-legend__item">
            <span className="enlight-legend__dot enlight-legend__dot--gold" />
            Mastered — passed all quiz tiers
          </span>
        </div>
