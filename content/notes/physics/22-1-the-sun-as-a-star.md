...
Exam Method for Describing Solar Energy Production:

State Composition: Identify that the Sun consists mostly of hydrogen and helium.

Describe Conditions: Explain that the Sun's massive size creates high density and temperature at its center.

Explain the Reaction: State that hydrogen nuclei combine (fuse) to become helium nuclei.

Mention Force: Note that the high temperatures allow the nuclei to overcome their electrostatic repulsion.

Identify Energy Source: Explain that energy is released because the mass of the resulting nuclei is less than the original mass.

## Common mistakes

Fission vs. Fusion: Stating that the Sun is powered by nuclear fission. Remember: Fusion is joining light nuclei.

Mass Conservation: Assuming mass is conserved in nuclear reactions. In the Sun, mass is converted into energy, so the final mass is less than the starting mass.

Sun's Size: Thinking the Sun is the largest object in the Universe. It is actually an average-sized star.

## Examiner tip

List Specific Regions: When asked about the Sun's radiation, always specify infrared, visible light, and ultraviolet regions.

Correct terminology: Use the phrase "fusion of hydrogen into helium" specifically, as this is the wording required for mark schemes.

## Quick check

What are the two primary gases that make up the Sun?

Which nuclear process—fission or fusion—occurs in the core of the Sun?

In a stable star, what outward force balances the inward pull of gravity?
...
Question: Describe the nuclear process that powers the Sun and state what happens to the mass during this process.

Identify the process: The process is nuclear fusion.

Identify the reactants: Hydrogen nuclei fuse together to form helium nuclei.
