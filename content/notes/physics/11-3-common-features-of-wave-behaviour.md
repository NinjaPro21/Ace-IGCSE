...
Waves exhibit several predictable behaviours when they encounter barriers, boundaries, or openings. Using a ripple tank to observe water waves, we can study the fundamental phenomena of reflection, refraction, and diffraction. These behaviours are common to all waves, including light and sound, and understanding them is essential for applications ranging from architectural acoustics to the design of optical instruments.
...
How does the wavelength of a water wave change when it moves from deep to shallow water?
