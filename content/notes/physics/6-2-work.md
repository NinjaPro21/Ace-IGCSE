...
You might think pushing as hard as you can against a brick wall is "work," but in Physics, if the wall doesn't move, no work is done. Work connects the concepts of force and energy, providing a precise way to measure how much energy is transferred when an object moves. From calculating the fuel needed to move cargo across the ocean to understanding the energy requirements of human movement, mastering "work done" is essential for predicting the physical costs of motion in real life.

## Key definitions

- **Work Done**: The product of the constant force and the distance moved by the object in the direction of the force.
- **Joule (J)**: The SI unit for work and energy. One joule is the work done by a force of one newton which moves an object through a distance of one metre in the direction of the force.
