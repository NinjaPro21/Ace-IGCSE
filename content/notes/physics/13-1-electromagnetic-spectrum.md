...
Light from the Sun travels as electromagnetic waves, which consist of different types of radiation that make up the electromagnetic spectrum. While the human eye can only detect visible light, this represents only a small portion of the entire spectrum. Other regions include radio waves, microwaves, infrared radiation, ultraviolet radiation, X-rays, and gamma rays.
