...
Electromagnetic (EM) waves transfer energy as they propagate, and the term radiation generally refers to this energy in transit. The amount of energy carried depends on the wave's frequency: for a given intensity, higher-frequency radiation (like X-rays or gamma rays) carries more energy than lower-frequency radiation (like radio waves).
