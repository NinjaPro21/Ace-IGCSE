...
Ever wondered why a heavy tractor doesn't sink into a muddy field while a person in high heels might leave deep marks in soft ground? Or why a sharp knife cuts through a tomato with ease compared to a blunt one? In Physics, we explain these phenomena using the concept of pressure. Understanding how force is spread over an area is not just crucial for passing your IGCSE exams; it is essential for engineering stable structures, designing safe sports equipment, and even medical applications where delicate tissues must be handled without damage.
...
If the contact area is doubled while the force remains the same, what happens to the pressure?

Write the word equation for pressure.
...
Remember: pressure depends on the contact area, not the total space the object occupies.
