...
Continue dividing until the remainder has degree strictly less than the divisor; the result is $f(x) = (\text{divisor}) \times Q(x) + R(x)$.
...
**Step 2 — Multiply and subtract:** $2x^2(x - 2) = 2x^3 - 4x^2$.
...
**Step 3 — Second term:** $-x^2 \div x = -x$. Multiply: $-x(x - 2) = -x^2 + 2x$.
...
**Step 4 — Third term:** $x \div x = 1$. Multiply: $1(x - 2) = x - 2$.
...
Quotient $Q(x) = 2x^2 - x + 1$, remainder $R(x) = 1$.

So $2x^3 - 5x^2 + 3x - 1 = (x - 2)(2x^2 - x + 1) + 1$.
