...
The gradient function (derivative) gives a formula for the slope of a curve at any point — the instantaneous rate of change of $y$ and $x$.
...
Question: Find $\frac{dy}{dx}$ when $y = 3x^4 - 2x + 7$.
