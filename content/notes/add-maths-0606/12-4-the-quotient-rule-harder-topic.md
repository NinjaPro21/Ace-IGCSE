...
The quotient rule is used when differentiating a **fraction** where both the numerator and denominator are functions of $x (e.g$ (2).
...
Question: Differentiate $y = \frac{3x}{x-2}$. $u = 3x$ when $. 2v = x-2$, $v' = 1$.
...
Question: Find $\frac{dy}{dx}$ for $y = \frac{x^2+4}{x+1}$. $u = x^2+4$, $u' = 2x$ when2, $v' = 1$.
