...
Calculus can be used to approximate small changes in dependent variables by assuming the curve behaves like a straight line over short intervals. This relationship also links rates of change with respect to time by using the chain rule to connect different related variables.
...
A spherical balloon has radius increasing at $2\,\text{cm/s}$. Find $\frac{dV}{dt}$ when $r = 5\,\text{cm}$, given $V = \frac{4}{3}\pi r^3$.

$$\frac{dV}{dr} = 4\pi r^2, \quad \frac{dr}{dt} = 2$$

$$\frac{dV}{dt} = 4\pi r^2 \times 2 = 8\pi r^2$$

At $r = 5$: $\frac{dV}{dt} = 8\pi(25) = 200\pi\,\text{cm}^3/\text{s}$.
