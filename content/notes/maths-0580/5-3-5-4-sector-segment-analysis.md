...
<div class="ace-physics-diagram"><svg viewBox="0 0 240 220" width="240" height="220" role="img" aria-label="Circle sector">
    ...
    </svg><p class="ace-physics-diagram__caption">Sector — fraction of circle area = $\theta/360$; arc length = $(\theta/360) \times 2\pi r$.</p></div>
