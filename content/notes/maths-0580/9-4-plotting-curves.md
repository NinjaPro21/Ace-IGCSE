...
<div class="ace-physics-diagram"><svg viewBox="0 0 640 220" width="640" height="220" role="img" aria-label="Quadratic graphs a positive and negative">
    ...
    </svg><p class="ace-physics-diagram__caption">Quadratic graph $y = ax^2 + bx + c$ — U-shape when $a > 0$ (left), ∩-shape when $a < 0$ (right); dots mark roots on the $x$-axis.</p></div>

<div class="ace-physics-diagram"><svg viewBox="0 0 320 220" width="320" height="220" role="img" aria-label="Cubic curve sketch">
    ...
    </svg><p class="ace-physics-diagram__caption">Cubic graph — S-shape; can have up to three x-axis intercepts and two turning points.</p></div>

<div class="ace-physics-diagram"><svg viewBox="0 0 320 220" width="320" height="220" role="img" aria-label="Reciprocal graph">
    ...
    </svg><p class="ace-physics-diagram__caption">Reciprocal graph $y = k/x$ — two branches in opposite quadrants; asymptotes at both axes.</p></div>
